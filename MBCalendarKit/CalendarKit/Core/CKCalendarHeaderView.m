...
- (void)willMoveToSuperview:(UIView *)newSuperview
{
    ...
    [self setBackgroundColor:[ UIColor colorWithWhite: 1.f alpha: 1.f ]/*kCalendarColorHeaderGradientDark*/];
}
...
- (void)layoutSubviews
{
    ...
    self.bottomSeparator = [ [ UIView alloc ] initWithFrame: CGRectMake( 0.f, self.frame.size.height - 1.f, self.frame.size.width, 1.f / [ [ UIScreen mainScreen ] scale ] ) ];
