...
{
    return [self rangeOfUnit:NSCalendarUnitSecond inUnit:NSCalendarUnitWeekOfMonth forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitMinute inUnit:NSCalendarUnitWeekOfMonth forDate:date].length;
}
...
{
    return [self rangeOfUnit:NSCalendarUnitHour inUnit:NSCalendarUnitWeekOfMonth forDate:date].length;
}
...
{
    return [[self components:NSCalendarUnitWeekOfMonth fromDate:fromDate toDate:toDate options:0] weekOfYear];
}
